...
const Navigation = () => {
  ...
  return (
    <nav className="bg-emerald-700 shadow-lg text-[#BD1521]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <Link to="/">
              <img className="h-8 border-2 rounded-full w-auto md:h-30" src={logo} alt="logo" />
            </Link>
          </div>
          ...
          <div className="hidden sm:flex space-x-6 ">
            ...
            <NavLink to="/checkInOut" text="Check-In/Out" />
            <NavLink to="/leaves" text="Leaves" />
            <NavLink to="/salary" text="Salary" />
      ...
      >
        <div className="px-4 pt-2 pb-3 space-y-2">
          <NavLinkMobile to="/" text="Dashboard" onClick={toggleMenu} />
          {isAuthenticated && <NavLinkMobile to="/profile" text="Profile" onClick={toggleMenu} />}
          <NavLinkMobile to="/checkInOut" text="Check-In/Out" onClick={toggleMenu} />
          <NavLinkMobile to="/leaves" text="Leaves" onClick={toggleMenu} />
          <NavLinkMobile to="/salary" text="Salary" onClick={toggleMenu} />
