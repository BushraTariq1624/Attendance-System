  ...
  return (
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden">
        {/* Card Header */}
        <div className="bg-emerald-700 text-white p-6 flex">
          <p className="text-gray-200 w-64 flex-1 ">Welcome back, {user.name}!</p>
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 p-2 bg-gray-50 rounded-md">{user.gender}</p>
          </div>
        ...
        <div className="bg-gray-50 p-4">
          ...
          <button
            onClick={() => navigate("/")}
            className="w-full bg-emerald-700 hover:bg-gray-900 text-white font-medium py-2 rounded-md transition-all duration-300"
          >
            Go to Home
          </button>
        </div>
