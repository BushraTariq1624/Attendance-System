      ...
      <div className="relative flex flex-col rounded-xl bg-white shadow-lg p-6 w-full max-w-md">
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            ...
            try {
              const response = await fetch(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/auth/user`, {
                method: "POST",
        ...
        >
          <Form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-emerald-700 hover:bg-gray-900 text-white font-medium py-2 rounded-md transition-all duration-300 disabled:bg-gray-500"
              disabled={loading}
            >
